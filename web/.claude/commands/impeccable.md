...
### Typography
→ *Consult [typography reference](impeccable/reference/typography.md) for OpenType features, web font loading, and the deeper material on scales.*
...
### Color & Theme
→ *Consult [color reference](impeccable/reference/color-and-contrast.md) for the deeper material on contrast, accessibility, and palette construction.*
...
### Layout & Space
→ *Consult [spatial reference](impeccable/reference/spatial-design.md) for the deeper material on grids, container queries, and optical adjustments.*
...
### Motion
→ *Consult [motion reference](impeccable/reference/motion-design.md) for timing, easing, and reduced motion.*
...
### Interaction
→ *Consult [interaction reference](impeccable/reference/interaction-design.md) for forms, focus, and loading patterns.*
...
### Responsive
→ *Consult [responsive reference](impeccable/reference/responsive-design.md) for mobile-first, fluid design, and container queries.*
...
### UX Writing
→ *Consult [ux-writing reference](impeccable/reference/ux-writing.md) for labels, errors, and empty states.*
...
If this skill is invoked with the argument "craft" (e.g., `{{command_prefix}}impeccable craft [feature description]`), follow the [craft flow](impeccable/reference/craft.md). Pass any additional arguments as the feature description.
...
If this skill is invoked with the argument "extract" (e.g., `{{command_prefix}}impeccable extract [target]`), follow the [extract flow](impeccable/reference/extract.md). Pass any additional arguments as the extraction target.
